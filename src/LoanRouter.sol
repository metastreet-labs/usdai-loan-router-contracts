    ...
    ReentrancyGuardTransient
{
    ...
    function _repayLenders(
        ...
        /* Calculate original principal to prorate prepayment */
     ...
     * @return True if target supports hooks interface, otherwise false
     */
    ...
    function repay(
        ...
        /* Calculate total repayment (less exit fee) */
